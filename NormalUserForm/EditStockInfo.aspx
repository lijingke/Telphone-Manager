<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditStockInfo.aspx.cs" Inherits="SystemManagerForm_EditStockInfo" %>
...
<body>
   ...
   <div>
        <asp:Label  runat="server" class="span2" >手机型号</asp:Label>
         <asp:TextBox runat="server" ID="model" Enabled="false" type="text"  class="input-large span3"></asp:TextBox>
   </div>
