<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Supply.aspx.cs" Inherits="SystemManagerForm_Supply" %>
...
<body>
   ...
   <div>
        ...
        <asp:DropDownList runat="server" class="span3" ID="model"  AutoPostBack="true" ></asp:DropDownList>
   </div>
